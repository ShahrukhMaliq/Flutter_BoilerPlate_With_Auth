...
class _SplashPageState extends State<SplashPage> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Center(
              ...
              child: Transform(
                ...
                child: Align(
                  ...
                  child: FadeTransition(
                    opacity:
                        DelayTween(begin: 0.0, end: 1.0, delay: delays[i]).animate(_controller),
                    child: SizedBox.fromSize(
                        size: Size.square(widget.size * 0.15), child: _itemBuilder(i)),
                  ),
                ),
              ),
            );
      ...
      const Text('please wait',style: TextStyle(inherit: false))])
    );
  }
